...
/// @title Cunoro Bond Depository V2
/// @author Zeus, Indigo
/// Review by: JeffX

contract CunoroBondDepositoryV2 is IBondDepository, NoteKeeper {
    /* ======== DEPENDENCIES ======== */
    ...
    constructor(
        ICunoroAuthority _authority,
        IERC20 _noro,
        IgNORO _gnoro,
        IStaking _staking,
        ITreasury _treasury
    ) NoteKeeper(_authority, _noro, _gnoro, _staking, _treasury) {
        // save gas for users by bulk approving stake() transactions
        _noro.approve(address(_staking), 1e45);
    }
     ...
     * @return payout_     the amount of gNORO due
        ...
        )
    {
         ...
         * price = quote tokens : noro (i.e. 42069 DAI : NORO)
         *
         * 1e18 = NORO decimals (9) + price decimals (9)
         */
         ...
         *
         * this is either the number of NORO that the market can sell
        ...
        // purchased, and how much NORO has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // noro decimals (9) + price decimals (9)
             ...
             * is 10,000 NORO. max payout would be 1,000 NORO (10,000 * 1 / 10).
             */
     ...
     * @param _market      [capacity (in NORO or quote), initial price / NORO (9 decimals), debt buffer (3 decimals)]
    ...
    function create(
         ...
         *
         * 1e18 = noro decimals (9) + initial price decimals (9)
         */
        uint64 targetDebt = uint64(_booleans[0] ? ((_market[0] * 1e18) / _market[1]) / 10**decimals : _market[0]);

        /*
         * max payout is the amount of capacity that should be utilized in a deposit
         * interval. for example, if capacity is 1,000 NORO, there are 10 days to conclusion,
         * and the preferred deposit interval is 1 day, max payout would be 100 NORO.
         */
        ...
        emit CreateMarket(id_, address(noro), address(_quoteToken), _market[1]);
    }
     ...
     * @param _id          ID of market
     * @return             price for market in NORO decimals
     *
     ...
     * @param _id          ID of market
     * @return             amount of NORO to be paid in NORO decimals
     *
     * @dev 1e18 = noro decimals (9) + market price decimals (9)
     */
     ...
     * @param _id          ID of market
     * @return             current debt for market in NORO decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in NORO decimals
     */
