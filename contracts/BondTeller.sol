...
contract BondTeller is ITeller, CunoroAccessControlled {
    /* ========== DEPENDENCIES ========== */
    ...
    struct Bond {
        ...
        uint256 payout; // sNORO remaining to be paid. agnostic balance
    ...
    IERC20 internal immutable NORO;
    IsNORO internal immutable sNORO; // payment token
    ...
    function newBond(
        ...
        NORO.approve(address(staking), _payout);
    ...
    function getReward() external override {
        ...
        FERs[msg.sender] = 0;
        NORO.safeTransfer(msg.sender, reward);
    }
    ...
    function pay(address _bonder, uint256 _amount) internal {
        sNORO.safeTransfer(_bonder, _amount);
    }
    ...
    /**
     * @notice calculate amount of NORO available for claim for single bond
     * @param _bonder address
    ...
    /**
     * @notice calculate amount of NORO available for claim for array of bonds
     * @param _bonder address
