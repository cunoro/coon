 ...
 * @title BaseAllocator
 * @notice
 *  This abstract contract serves as a template for writing new Cunoro Allocators.
 ...
 */
abstract contract BaseAllocator is CunoroAccessControlledV2, IAllocator {
    ...
    constructor(AllocatorInitData memory data) CunoroAccessControlledV2(data.authority) {
        _tokens = data.tokens;
