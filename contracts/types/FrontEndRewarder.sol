...
abstract contract FrontEndRewarder is CunoroAccessControlled {
    /* ========= STATE VARIABLES ========== */
    ...
    IERC20 internal immutable noro; // reward token

    constructor(ICunoroAuthority _authority, IERC20 _noro) CunoroAccessControlled(_authority) {
        noro = _noro;
    }
    ...
    function getReward() external {
        ...
        noro.transfer(msg.sender, reward);
    }
