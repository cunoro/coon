...
async function main() {
  ...
  let AvaxBondDepository = await ethers.getContractFactory( 'CunoroAvaxBondDepository')
  let bond = AvaxBondDepository.attach('0x53E4DAFF2073f848DC3F7a8D7CC95b3607212A73')
