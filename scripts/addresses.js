...
const AVALANCHE_MUMBAI = {
  ...
  RESERVES: {
    ...
    MAI_NORO: '0x578cEa575734D4d3A3Fb68872e41535746E375bE',
  },
  BONDS: {
    MAI: '0x049bf8be5033624aFA213F821116a4E80445864c',
    MAI_NORO: '0x7091cEEB04A1574eBBA2B75F7E78b16aa39CA9b8',
    MAI_NORO_V2: '0x7091cEEB04A1574eBBA2B75F7E78b16aa39CA9b8',
  },
...
function getAddresses(networkID) {
  if (networkID === 137) return AVALANCHE_MAINNET
  if (networkID === 80001) return AVALANCHE_MUMBAI
  if (networkID === 31337) return AVALANCHE_MAINNET
