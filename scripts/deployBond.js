let addresses = {
  ...
  RESERVES: {
    ...
    FRAX_NORO: '0x167F06eb4242fe3e5436dB7Ffa06bdE3c18Fc999',
  },
  BONDS: {
...
const reserveAddr = addresses.RESERVES.FRAX_NORO
const isLPBond = true
...
async function main() {
  ...
  // )
  const calcAddr = isLPBond ? addresses.NORO_BONDING_CALC_ADDRESS : zeroAddress
