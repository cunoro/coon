let addresses = {
  ...
  BONDS: {
    ...
    OLD_MAI_COON: '0x64c766f9A4936c3a4b51C55Ea5C4854E19766035',
...
const ERC20 = await ethers.getContractFactory('CunoroCoonERC20V2')
let clam = ERC20.attach(addresses.COON_ADDRESS)
let mai = ERC20.attach(addresses.MAI_ADDRESS)

const StakedCunoroCoonERC20V2 = await ethers.getContractFactory('StakedCunoroCoonERC20V2')
let sCoon = StakedCunoroCoonERC20V2.attach(addresses.sCOON_ADDRESS).connect(deployer)
...
let FraxBond = await ethers.getContractFactory('CunoroBondStakeDepository')
// let fraxBond = FraxBond.attach('0x5Fa0FBDb07Fe9647B43426dcc79da984f0327E4a')
let fraxBond = await FraxBond.deploy( addresses.COON_ADDRESS, addresses.sCOON_ADDRESS, fraxAddr, addresses.TREASURY_ADDRESS, '0x929a27c46041196e1a49c7b459d63ec9a20cd879', zeroAddress)
