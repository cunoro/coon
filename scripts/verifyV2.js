...
async function main() {
  ...
  //   address.DAI_ADDRESS,
  //   address.RESERVES.DAI_NORO,
  //   address.NORO_BONDING_CALC_ADDRESS,
  //   '43200',
  // ])
  ...
  //   firstEpochEndTime,
  // ])
  await verify(stakingWarmup, [address.STAKING_ADDRESS, address.sNORO_ADDRESS])
  // await verify(address.STAKING_HELPER_ADDRESS, [
  //   address.STAKING_ADDRESS,
  //   address.NORO_ADDRESS,
  // ])
  // await verify(address.BONDS.DAI, [
  //   address.NORO_ADDRESS,
  //   address.DAI_ADDRESS,
  //   address.TREASURY_ADDRESS,
  //   daoAddr,
  //   zeroAddress,
  // ])
  // await verify(address.BONDS.DAI_NORO, [
  //   address.NORO_ADDRESS,
  //   address.RESERVES.DAI_NORO,
  //   address.TREASURY_ADDRESS,
  //   daoAddr,
