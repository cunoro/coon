...
async function main() {
  ...
  await verify(address.COON_BONDING_CALC_ADDRESS,[address.COON_ADDRESS])
  // await verify(newCoon.address, [])
  // await verify(address.sCOON_ADDRESS, [])
  // await verify(address.COON_CIRCULATING_SUPPLY, [deployer.address])
  // await verify(address.TREASURY_ADDRESS, [
  //   address.COON_ADDRESS,
  //   address.MAI_ADDRESS,
  //   address.RESERVES.MAI_COON,
  //   address.COON_BONDING_CALC_ADDRESS,
  //   '43200',
  // ])
  ...
  //   address.COON_ADDRESS,
  //   address.sCOON_ADDRESS,
  //   epochLengthInSeconds,
  //   firstEpochNumber,
  //   firstEpochEndTime,
  // ])
  await verify(stakingWarmup, [address.STAKING_ADDRESS, address.sCOON_ADDRESS])
  ...
  //   zeroAddress,
  // ])
  // await verify(address.BONDS.MAI_COON, [
  //   address.COON_ADDRESS,
  //   address.RESERVES.MAI_COON,
  //   address.TREASURY_ADDRESS,
  //   daoAddr,
