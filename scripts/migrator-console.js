...
let clam = ERC20.attach(addresses.OLD_COON_ADDRESS)
let clam2 = ERC20.attach(addresses.COON_ADDRESS)
...
let sCoon = StakedCunoroCoonERC20V2.attach(addresses.OLD_SCOON_ADDRESS).connect(deployer)
let sCoon2 = StakedCunoroCoonERC20V2.attach(addresses.sCOON_ADDRESS).connect(deployer)
...
// await sCoon2.setIndex(sCoon.index())
...
await newTreasury.toggle('4', addresses.BONDS.MAI_COON, zeroAddress)
