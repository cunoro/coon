...
async function main() {
  ...
  let MaticBondDepository = await ethers.getContractFactory(
    'OtterMaticLPBondDepository'
  )
  let bond = MaticBondDepository.attach('0x1dAc605bDD4e8F3ab23da9B360e672f4e973A196')
