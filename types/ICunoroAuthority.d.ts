...
interface ICunoroAuthorityInterface extends ethers.utils.Interface {
  functions: {
...
export class ICunoroAuthority extends BaseContract {
  ...
  interface: ICunoroAuthorityInterface;
