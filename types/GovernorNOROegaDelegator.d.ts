...
interface GovernorNOROegaDelegatorInterface extends ethers.utils.Interface {
  functions: {
...
export class GovernorNOROegaDelegator extends BaseContract {
  ...
  interface: GovernorNOROegaDelegatorInterface;
