...
interface CunoroBondDepositoryInterface extends ethers.utils.Interface {
  functions: {
...
export class CunoroBondDepository extends BaseContract {
  ...
  interface: CunoroBondDepositoryInterface;
