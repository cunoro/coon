...
interface CunoroBondingCalculatorInterface extends ethers.utils.Interface {
  functions: {
...
export class CunoroBondingCalculator extends BaseContract {
  ...
  interface: CunoroBondingCalculatorInterface;
