...
import type {
  CunoroAuthority,
  CunoroAuthorityInterface,
} from "../CunoroAuthority";
...
export class CunoroAuthority__factory extends ContractFactory {
  constructor(
  ...
  attach(address: string): CunoroAuthority {
    return super.attach(address) as CunoroAuthority;
  }
  connect(signer: Signer): CunoroAuthority__factory {
    return super.connect(signer) as CunoroAuthority__factory;
  }
  static readonly bytecode = _bytecode;
  static readonly abi = _abi;
  static createInterface(): CunoroAuthorityInterface {
    return new utils.Interface(_abi) as CunoroAuthorityInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CunoroAuthority {
    return new Contract(address, _abi, signerOrProvider) as CunoroAuthority;
  }
}
