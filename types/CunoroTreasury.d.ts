...
interface CunoroTreasuryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "repayDebtWithNORO(uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "noroDebt", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "repayDebtWithNORO",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "noroDebt", data: BytesLike): Result;
...
export class CunoroTreasury extends BaseContract {
  ...
  interface: CunoroTreasuryInterface;
  ...
  functions: {
    ...
    noroDebt(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    noroDebt(overrides?: CallOverrides): Promise<PopulatedTransaction>;
