...
interface GovernorNOROegaEventsInterface extends ethers.utils.Interface {
  functions: {};
...
export class GovernorNOROegaEvents extends BaseContract {
  ...
  interface: GovernorNOROegaEventsInterface;
